...
@Entity
@Table(name = "tbl_quick_marks_copy")
public class QuickMarkCopy {
    ...
    public QuickMarkCopy() {
    }

    public QuickMarkCopy(int id) {
        this.id = id;
    }
    ...
    public QuickMarkCopy(int id, String matricNo, String studentName, String program, String semester, String subject1Name, String subject2Name, String subject3Name, String subject4Name, String subject5Name, float subject1Mark, float subject2Mark, float subject3Mark, float subject4Mark, float subject5Mark, String subject1Code, String subject2Code, String subject3Code, String subject4Code, String subject5Code, int subject1CreditHour, int subject2CreditHour, int subject3CreditHour, int subject4CreditHour, int subject5CreditHour) {
        this.id = id;
        this.matricNo = matricNo;
        this.studentName = studentName;
        this.program = program;
